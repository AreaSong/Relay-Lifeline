...
void i18n.use(initReactI18next).init({
  resources: {
    "zh-CN": { common: commonZh, auth: authZh, overview: overviewZh, requests: requestsZh, settings: settingsZh, diagnostics: diagnosticsZh, errors: errorsZh, logs: logsZh, captures: capturesZh },
    "en-US": { common: commonEn, auth: authEn, overview: overviewEn, requests: requestsEn, settings: settingsEn, diagnostics: diagnosticsEn, errors: errorsEn, logs: logsEn, captures: capturesEn },
  },
  lng: initialLocale,
  fallbackLng: "en-US",
  supportedLngs: supportedLocales,
  ns: ["common", "auth", "overview", "requests", "settings", "diagnostics", "errors", "logs", "captures"],
  defaultNS: "common",
