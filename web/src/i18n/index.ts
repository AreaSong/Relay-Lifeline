...
void i18n.use(initReactI18next).init({
  resources: {
    "zh-CN": { common: commonZh, auth: authZh, overview: overviewZh, requests: requestsZh, settings: settingsZh, diagnostics: diagnosticsZh, errors: errorsZh },
    "en-US": { common: commonEn, auth: authEn, overview: overviewEn, requests: requestsEn, settings: settingsEn, diagnostics: diagnosticsEn, errors: errorsEn },
  },
  lng: initialLocale,
  fallbackLng: "en-US",
  supportedLngs: supportedLocales,
  ns: ["common", "auth", "overview", "requests", "settings", "diagnostics", "errors"],
  defaultNS: "common",
